	...
	FOREACH_BS(index, selector) {
		...
		for (int whichOr = 0; whichOr < myOr.size(); whichOr++) {			
			...
			if (myOr[whichOr].left.code == NAME) {
				...
				if (leftSchema->Find (myOr[whichOr].left.value) != -1) {
					cnf.orList[whichAnd][whichOr].operand1 = Left;
					cnf.orList[whichAnd][whichOr].whichAtt1 =
						leftSchema->Find (myOr[whichOr].left.value);	
					typeLeft = leftSchema->FindType (myOr[whichOr].left.value);

				// see if we can find it in the right schema
				} else if (rightSchema->Find (myOr[whichOr].left.value) != -1) {
                                        cnf.orList[whichAnd][whichOr].operand1 = Right;
                                        cnf.orList[whichAnd][whichOr].whichAtt1 =
                                                rightSchema->Find (myOr[whichOr].left.value);
                                        typeLeft = rightSchema->FindType (myOr[whichOr].left.value);
			...
			if (myOr[whichOr].right.code == NAME) {
				...
				// see if we can find this attribute in the left schema
				if (leftSchema->Find (myOr[whichOr].right.value) != -1) {
					cnf.orList[whichAnd][whichOr].operand2 = Left;
					cnf.orList[whichAnd][whichOr].whichAtt2 =
						leftSchema->Find (myOr[whichOr].right.value);	
					typeRight = leftSchema->FindType (myOr[whichOr].right.value);

				// see if we can find it in the right schema
				} else if (rightSchema->Find (myOr[whichOr].right.value) != -1) {
                                        cnf.orList[whichAnd][whichOr].operand2 = Right;
                                        cnf.orList[whichAnd][whichOr].whichAtt2 =
                                                rightSchema->Find (myOr[whichOr].right.value);
					typeRight = rightSchema->FindType (myOr[whichOr].right.value);
	...
	FOREACH_BS(index, selector) {
		...
		for (int whichOr = 0; whichOr < myOr.size(); whichOr++) {			
			...
			if (myOr[whichOr].left.code == NAME) {
				...
				if (mySchema->Find (myOr[whichOr].left.value) != -1) {
					cnf.orList[whichAnd][whichOr].operand1 = Left;
					cnf.orList[whichAnd][whichOr].whichAtt1 =
						mySchema->Find (myOr[whichOr].left.value);	
					typeLeft = mySchema->FindType (myOr[whichOr].left.value);
			...
			if (myOr[whichOr].right.code == NAME) {
				...
				// see if we can find this attribute in the left schema
				if (mySchema->Find (myOr[whichOr].right.value) != -1) {
					cnf.orList[whichAnd][whichOr].operand2 = Left;
					cnf.orList[whichAnd][whichOr].whichAtt2 =
						mySchema->Find (myOr[whichOr].right.value);	
					typeRight = mySchema->FindType (myOr[whichOr].right.value);
